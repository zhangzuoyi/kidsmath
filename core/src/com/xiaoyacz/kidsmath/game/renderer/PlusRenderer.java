...
public class PlusRenderer implements AbstractRenderer {
	private GameScreen screen;
	private NumPlusModel model;
	...
	public PlusRenderer(NumPlusModel model, GameScreen screen){
		this.model=model;
		this.screen=screen;
	}
...
//		num1.setSize(BALLOON_SIZE, BALLOON_SIZE);
		...
		x=x+cellMargin+cellWidth;
		operation=new Sprite(Assets.instance.tplus);
...
//		num2.setSize(BALLOON_SIZE, BALLOON_SIZE);
	...
	public void playSound(){
		Assets.instance.sounds.plusExpression(model.getNum1(), model.getNum2());
	}
